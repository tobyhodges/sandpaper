...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e94217db435...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e94217db435...
#> ☐ Edit /tmp/RtmpJqrPL6/file1e94217db435/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e94217db435...
#> ✔ First episode created in /tmp/RtmpJqrPL6/file1e94217db435/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e94217db435...
...
#> - R             [* -> 4.5.3]
#> 
#> - Lockfile written to "/tmp/RtmpJqrPL6/file1e94217db435/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpJqrPL6/file1e94217db435
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e94217db435...
lsn
#> /tmp/RtmpJqrPL6/file1e94217db435
```
