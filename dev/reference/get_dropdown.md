...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e9448e3a8af...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e9448e3a8af...
#> ☐ Edit /tmp/RtmpJqrPL6/file1e9448e3a8af/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e9448e3a8af...
#> ✔ First episode created in /tmp/RtmpJqrPL6/file1e9448e3a8af/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e9448e3a8af...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e9448e3a8af...
#> ✔ Lesson successfully created in /tmp/RtmpJqrPL6/file1e9448e3a8af
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e9448e3a8af...
#> /tmp/RtmpJqrPL6/file1e9448e3a8af
get_episodes(tmp)
#> [1] "introduction.md"
