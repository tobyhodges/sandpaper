...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e947560b08f...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e947560b08f...
#> ☐ Edit /tmp/RtmpJqrPL6/file1e947560b08f/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e947560b08f...
#> ✔ First episode created in /tmp/RtmpJqrPL6/file1e947560b08f/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e947560b08f...
...
#> - R             [* -> 4.5.3]
#> 
#> - Lockfile written to "/tmp/RtmpJqrPL6/file1e947560b08f/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/RtmpJqrPL6/file1e947560b08f
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e947560b08f...
#> ☐ Edit /tmp/RtmpJqrPL6/file1e947560b08f/episodes/getting-started.md.
#> ☐ Edit /tmp/RtmpJqrPL6/file1e947560b08f/episodes/plotting.Rmd.
#> ☐ Edit /tmp/RtmpJqrPL6/file1e947560b08f/episodes/experimental.md.
#> episodes:
#> - introduction.Rmd
#> - getting-started.md
#> - plotting.Rmd
