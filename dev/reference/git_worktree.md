...
#> ℹ Lesson bootstrapped in 3.346119 secs
#> → Bootstrapping example lesson
...
#> ℹ Remote set up in 0.01413369 secs
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 3.38 seconds
tik <- Sys.time()
...
#> [md-outputs (root-commit) f882120] Initializing md-outputs branch
#> Running git push sandpaper-local 'HEAD:md-outputs'
#> To /tmp/RtmpJqrPL6/REMOTE-1e9417b239a5
...
#> From /tmp/RtmpJqrPL6/REMOTE-1e9417b239a5
...
#>   /tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example/site/built \
#>   sandpaper-local/md-outputs
#> Preparing worktree (resetting branch 'md-outputs'; was at f882120)
#> branch 'md-outputs' set up to track 'sandpaper-local/md-outputs'.
#> HEAD is now at f882120 Initializing md-outputs branch
#> ::endgroup::
...
#> [gh-pages (root-commit) 681df58] Initializing gh-pages branch
...
#>   /tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example/site/docs \
#>   sandpaper-local/gh-pages
#> Preparing worktree (resetting branch 'gh-pages'; was at 681df58)
#> branch 'gh-pages' set up to track 'sandpaper-local/gh-pages'.
#> HEAD is now at 681df58 Initializing gh-pages branch
#> ::endgroup::
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
...
tok <- Sys.time()
cli::cli_alert_info("Elapsed time: {round(tok - tik, 2)} seconds")
#> ℹ Elapsed time: 13.3 seconds
tik <- Sys.time()
cli::cli_h1("Clean Up")
#> 
#> ── Clean Up ────────────────────────────────────────────────────────────
cli::cli_alert_info("object db is an expression that evaluates to {.code {db}}")
#> ℹ object db is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example/site/built", "/tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example")`
eval(db)
...
#> ℹ object ds is an expression that evaluates to `sandpaper:::github_worktree_remove("/tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example/site/docs", "/tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example")`
eval(ds)
#> Running git worktree remove --force \
#>   /tmp/RtmpJqrPL6/file1e94272dd9a4/lesson-example/site/docs
#> $status
...
#> ℹ removing 'sandpaper-local' (/tmp/RtmpJqrPL6/REMOTE-1e9417b239a5)
#> /tmp/RtmpJqrPL6/REMOTE-1e9417b239a5
