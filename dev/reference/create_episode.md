...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942b0badfe...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942b0badfe...
#> ☐ Edit /tmp/RtmpJqrPL6/file1e942b0badfe/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942b0badfe...
#> ✔ First episode created in /tmp/RtmpJqrPL6/file1e942b0badfe/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942b0badfe...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942b0badfe...
#> ✔ Lesson successfully created in /tmp/RtmpJqrPL6/file1e942b0badfe
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942b0badfe...
#> /tmp/RtmpJqrPL6/file1e942b0badfe
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpJqrPL6/file1e942b0badfe/episodes/getting-started.md.
#> /tmp/RtmpJqrPL6/file1e942b0badfe/episodes/getting-started.md
```
