...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpJqrPL6/file1e942e923994': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942e923994...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942e923994...
#> ☐ Edit /tmp/RtmpJqrPL6/file1e942e923994/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942e923994...
#> ✔ First episode created in /tmp/RtmpJqrPL6/file1e942e923994/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942e923994...
...
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942e923994...
#> ✔ Lesson successfully created in /tmp/RtmpJqrPL6/file1e942e923994
#> → Creating Lesson in /tmp/RtmpJqrPL6/file1e942e923994...
#> /tmp/RtmpJqrPL6/file1e942e923994
...
#> [1] "/tmp/RtmpJqrPL6/file1e942e923994/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpJqrPL6/file1e942e923994/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpJqrPL6/file1e942e923994/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpJqrPL6/file1e942e923994/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpJqrPL6/file1e942e923994/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpJqrPL6/file1e942e923994/README.md
#> 
#> $index.md
#> /tmp/RtmpJqrPL6/file1e942e923994/index.md
#> 
#> $links.md
#> /tmp/RtmpJqrPL6/file1e942e923994/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpJqrPL6/file1e942e923994/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpJqrPL6/file1e942e923994/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpJqrPL6/file1e942e923994/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpJqrPL6/file1e942e923994/profiles/learner-profiles.md
#> 
