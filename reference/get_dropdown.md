...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5843959c0f...
...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5843959c0f...
#> ☐ Edit /tmp/RtmpbSPUVK/file1e5843959c0f/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5843959c0f...
#> ✔ First episode created in /tmp/RtmpbSPUVK/file1e5843959c0f/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5843959c0f...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5843959c0f...
#> ✔ Lesson successfully created in /tmp/RtmpbSPUVK/file1e5843959c0f
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5843959c0f...
#> /tmp/RtmpbSPUVK/file1e5843959c0f
get_episodes(tmp)
#> [1] "introduction.md"
