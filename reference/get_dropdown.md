...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad6db56e34...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad6db56e34...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad6db56e34/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad6db56e34...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cad6db56e34/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad6db56e34...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad6db56e34...
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cad6db56e34
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad6db56e34...
#> /tmp/Rtmp2vyL1A/file1cad6db56e34
get_episodes(tmp)
#> [1] "introduction.md"
