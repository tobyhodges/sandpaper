...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad1af988fb...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad1af988fb...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad1af988fb/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad1af988fb...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cad1af988fb/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad1af988fb...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad1af988fb...
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cad1af988fb
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad1af988fb...
#> /tmp/Rtmp2vyL1A/file1cad1af988fb
check_lesson(tmp)
