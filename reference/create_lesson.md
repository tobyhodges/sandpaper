...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cadc8c36ea...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cadc8c36ea...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cadc8c36ea/episodes/introduction.Rmd.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cadc8c36ea...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cadc8c36ea/episodes/introduction.Rmd
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cadc8c36ea...
...
#> - R             [* -> 4.6.0]
#> 
#> - Lockfile written to "/tmp/Rtmp2vyL1A/file1cadc8c36ea/renv/profiles/lesson-requirements/renv.lock".
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cadc8c36ea
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cadc8c36ea...
lsn
#> /tmp/Rtmp2vyL1A/file1cadc8c36ea
```
