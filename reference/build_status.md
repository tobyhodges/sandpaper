...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp2vyL1A/file1cad3f70eab6': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad3f70eab6...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad3f70eab6...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad3f70eab6...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad3f70eab6...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad3f70eab6...
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cad3f70eab6
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad3f70eab6...
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6
...
#> $build
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/index.md
#> 
#> $new
#>                                                                               file
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md episodes/introduction.md
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/index.md                                 index.md
#>                                                                                   checksum
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/index.md                 a02c9c785ed98ddd84fe3d34ddb12fcd
#>                                                                                built
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md site/built/introduction.md
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/index.md                        site/built/index.md
#>                                                                 date
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.md 2026-05-13
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/index.md                 2026-05-13
#> 
...
#>                        built       date
#> 1 site/built/introduction.md 2026-05-13
#> 2        site/built/index.md 2026-05-13
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
...
sp$build_status(resources, db, write = TRUE)
#> $build
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/episodes/introduction.Rmd
#> 
#> $remove
#> /tmp/Rtmp2vyL1A/file1cad3f70eab6/site/built/introduction.md
#> 
#> $new
#>                        file                         checksum
...
#>                        built       date
#> 2 site/built/introduction.md 2026-05-13
#> 1        site/built/index.md 2026-05-13
#> 
#> $old
#>                       file                         checksum
#> 1 episodes/introduction.md fd46501f174bb7e6cc280a1436fbc12a
