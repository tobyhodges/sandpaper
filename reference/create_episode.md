...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad59454680...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad59454680...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad59454680/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad59454680...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cad59454680/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad59454680...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad59454680...
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cad59454680
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad59454680...
#> /tmp/Rtmp2vyL1A/file1cad59454680
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad59454680/episodes/getting-started.md.
#> /tmp/Rtmp2vyL1A/file1cad59454680/episodes/getting-started.md
```
