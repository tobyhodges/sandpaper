...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58a750e0...
...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58a750e0...
#> ☐ Edit /tmp/RtmpbSPUVK/file1e58a750e0/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58a750e0...
#> ✔ First episode created in /tmp/RtmpbSPUVK/file1e58a750e0/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58a750e0...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58a750e0...
#> ✔ Lesson successfully created in /tmp/RtmpbSPUVK/file1e58a750e0
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58a750e0...
#> /tmp/RtmpbSPUVK/file1e58a750e0
create_episode_md("getting-started", path = tmp)
#> ☐ Edit /tmp/RtmpbSPUVK/file1e58a750e0/episodes/getting-started.md.
#> /tmp/RtmpbSPUVK/file1e58a750e0/episodes/getting-started.md
```
