...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp2vyL1A/file1cad59f13983': no such file or directory
...
#> 
#> $paths
#> /tmp/Rtmp2vyL1A/file1cad59f13983/index.html
#> /tmp/Rtmp2vyL1A/file1cad59f13983/instructor/index.html
#> 
```
