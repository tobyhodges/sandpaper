...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpbSPUVK/file1e583772fc12': no such file or directory
...
#> 
#> $paths
#> /tmp/RtmpbSPUVK/file1e583772fc12/index.html
#> /tmp/RtmpbSPUVK/file1e583772fc12/instructor/index.html
#> 
```
