...
#> Error: [ENOENT] Failed to search directory '/tmp/RtmpbSPUVK/file1e5878785407': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5878785407...
...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5878785407...
#> ☐ Edit /tmp/RtmpbSPUVK/file1e5878785407/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5878785407...
#> ✔ First episode created in /tmp/RtmpbSPUVK/file1e5878785407/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5878785407...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5878785407...
#> ✔ Lesson successfully created in /tmp/RtmpbSPUVK/file1e5878785407
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e5878785407...
#> /tmp/RtmpbSPUVK/file1e5878785407
...
#> [1] "/tmp/RtmpbSPUVK/file1e5878785407/episodes/introduction.Rmd"
#> [2] "/tmp/RtmpbSPUVK/file1e5878785407/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/RtmpbSPUVK/file1e5878785407/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/RtmpbSPUVK/file1e5878785407/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/RtmpbSPUVK/file1e5878785407/LICENSE.md
#> 
#> $README.md
#> /tmp/RtmpbSPUVK/file1e5878785407/README.md
#> 
#> $index.md
#> /tmp/RtmpbSPUVK/file1e5878785407/index.md
#> 
#> $links.md
#> /tmp/RtmpbSPUVK/file1e5878785407/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/RtmpbSPUVK/file1e5878785407/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/RtmpbSPUVK/file1e5878785407/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/RtmpbSPUVK/file1e5878785407/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/RtmpbSPUVK/file1e5878785407/profiles/learner-profiles.md
#> 
