...
#> Error: [ENOENT] Failed to search directory '/tmp/Rtmp2vyL1A/file1cad76161076': no such file or directory
create_lesson(tmp, rmd = FALSE, open = FALSE)
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad76161076...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad76161076...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad76161076/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad76161076...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cad76161076/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad76161076...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad76161076...
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cad76161076
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad76161076...
#> /tmp/Rtmp2vyL1A/file1cad76161076
...
#> [1] "/tmp/Rtmp2vyL1A/file1cad76161076/episodes/introduction.Rmd"
#> [2] "/tmp/Rtmp2vyL1A/file1cad76161076/episodes/files/hi.md"     
#> 
#> $CODE_OF_CONDUCT.md
#> /tmp/Rtmp2vyL1A/file1cad76161076/CODE_OF_CONDUCT.md
#> 
#> $CONTRIBUTING.md
#> /tmp/Rtmp2vyL1A/file1cad76161076/CONTRIBUTING.md
#> 
#> $LICENSE.md
#> /tmp/Rtmp2vyL1A/file1cad76161076/LICENSE.md
#> 
#> $README.md
#> /tmp/Rtmp2vyL1A/file1cad76161076/README.md
#> 
#> $index.md
#> /tmp/Rtmp2vyL1A/file1cad76161076/index.md
#> 
#> $links.md
#> /tmp/Rtmp2vyL1A/file1cad76161076/links.md
#> 
#> $`instructors/instructor-notes.md`
#> /tmp/Rtmp2vyL1A/file1cad76161076/instructors/instructor-notes.md
#> 
#> $`learners/reference.md`
#> /tmp/Rtmp2vyL1A/file1cad76161076/learners/reference.md
#> 
#> $`learners/setup.md`
#> /tmp/Rtmp2vyL1A/file1cad76161076/learners/setup.md
#> 
#> $`profiles/learner-profiles.md`
#> /tmp/Rtmp2vyL1A/file1cad76161076/profiles/learner-profiles.md
#> 
