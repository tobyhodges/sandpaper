...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad39b7b44a...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad39b7b44a...
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad39b7b44a/episodes/introduction.md.
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad39b7b44a...
#> ✔ First episode created in /tmp/Rtmp2vyL1A/file1cad39b7b44a/episodes/introduction.md
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad39b7b44a...
...
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad39b7b44a...
#> ✔ Lesson successfully created in /tmp/Rtmp2vyL1A/file1cad39b7b44a
#> → Creating Lesson in /tmp/Rtmp2vyL1A/file1cad39b7b44a...
#> /tmp/Rtmp2vyL1A/file1cad39b7b44a
create_episode("first-script", path = tmp, open = FALSE)
#> ☐ Edit /tmp/Rtmp2vyL1A/file1cad39b7b44a/episodes/first-script.Rmd.
#> /tmp/Rtmp2vyL1A/file1cad39b7b44a/episodes/first-script.Rmd
check_lesson(tmp)
build_lesson(tmp)
#> ── Initialising site ───────────────────────────────────────────────────
