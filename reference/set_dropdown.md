...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58af1ce30...
...
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58af1ce30...
#> ☐ Edit /tmp/RtmpbSPUVK/file1e58af1ce30/episodes/introduction.md.
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58af1ce30...
#> ✔ First episode created in /tmp/RtmpbSPUVK/file1e58af1ce30/episodes/introduction.md
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58af1ce30...
#> ℹ Workflows up-to-date!
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58af1ce30...
#> ✔ Lesson successfully created in /tmp/RtmpbSPUVK/file1e58af1ce30
#> → Creating Lesson in /tmp/RtmpbSPUVK/file1e58af1ce30...
#> /tmp/RtmpbSPUVK/file1e58af1ce30
# Change the title and License
set_config(c(title = "Absolutely Free Lesson", license = "CC0"),
  path = tmp,
  write = TRUE
)
#> ℹ Writing to /tmp/RtmpbSPUVK/file1e58af1ce30/config.yaml
#> → title: 'test lesson' -> title: 'Absolutely Free Lesson'
#> → license: 'CC-BY 4.0' -> license: 'CC0'
create_episode("using-R", path = tmp, open = FALSE)
#> ☐ Edit /tmp/RtmpbSPUVK/file1e58af1ce30/episodes/using-r.Rmd.
#> /tmp/RtmpbSPUVK/file1e58af1ce30/episodes/using-r.Rmd
